...
export default async function AccountLayout({ children }: { children: React.ReactNode }) {
  ...
  const links = [["Dashboard", "/account"], ["My Orders", "/account/orders"], ["Address Book", "/account/addresses"], ["Wishlist", "/account/wishlist"], ["My Reviews", "/account/reviews"], ["Account Details", "/account/profile"]];
